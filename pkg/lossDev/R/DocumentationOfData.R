...
##' An and example of an incremental loss triangle.
##'
##' Rows pertain to accident years; and columns pertain to development years.
...
##' "Which Stochastic Model is Underlying the Chain Ladder Method," http://www.casact.org/pubs/forum/95fforum/95ff229.pdf

...
#ifndef EXPANDABLEARRAY_H_
#define EXPANDABLEARRAY_H_
...
public:
    ...
    void makeSufficientWithoutCopy(unsigned int const & length);
    void makeSufficientWithCopy(unsigned int const & length);
    double *value();
};
#endif /*EXPANDABLEARRAY_H_*/

...
<p> Feel free to download and try the current release of <strong>lossDev</strong>, <a href="pkg/lossDev_0.9.3.zip"> version 0.9.3</a>, which requires <strong>R</strong> version 2.11.1 or greater.
...
For Linux installations one will need the tar.gz file available here <a href="pkg/lossDev_0.9.3.tar.gz"> lossDev_0.9.3.tar.gz.</a>

...
setClass(
         ...
         representation(
                        ...
                        exposureYears='integer',                  #a vector of years which correspond to the rows in the triangle
...
##' Methods should return a new object with @triangleType set to 'py.with.folded.half'.
